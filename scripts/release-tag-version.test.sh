...
refuses v1.2.3-01 'a purely numeric identifier with a leading zero names the same release as -1'
refuses v1.2.3-rc.01 'the leading-zero rule holds for every identifier, not only the first'
